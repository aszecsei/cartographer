...
class Delaunator {
  ...
  constructor(coords) {
    ...
    let i0, i1, i2; // pick a seed point close to the centroid
    ...
    for (let k = 0, xp, yp; k < ids.length; k++) {
      ...
      if (!e) continue;
      const walkBack = e === start; // add the first triangle from the point
...
class Delaunay {
  constructor(points) {
    const {
      ...
      hull,
      triangles
    } = new _delaunator.default(points);
    this.points = points;
...
var _loop_1 = function _loop_1(plate_idx) {
  ctx.beginPath();
...
},{"d3-delaunay":"../node_modules/d3-delaunay/src/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
