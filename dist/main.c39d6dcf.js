...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./delaunay.js":"../node_modules/d3-delaunay/src/delaunay.js","./voronoi.js":"../node_modules/d3-delaunay/src/voronoi.js"}],"main.ts":[function(require,module,exports) {
"use strict";
...
function heightGen(voronoi, points) {
  ...
  for (var i = 0; i < NUM_PLATE_STEPS; i++) {
    for (var cell = 0; cell < NUM_POINTS; cell++) {
      var cell_point = points[cell];
      var neighbor_cells = neighbors[cell];

      for (var _i = 0, neighbor_cells_1 = neighbor_cells; _i < neighbor_cells_1.length; _i++) {
        var neighbor_cell_idx = neighbor_cells_1[_i];
...
function main() {
  ...
  var _loop_2 = function _loop_2(plate_idx) {
    ...
    for (var i = 0; i < pl; i++) {
      ...
      var height_percent = (p.p.height - min_height) / (max_height - min_height) * 100;
...
main();
},{"./math/vec2":"math/vec2.ts","d3-delaunay":"../node_modules/d3-delaunay/src/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
